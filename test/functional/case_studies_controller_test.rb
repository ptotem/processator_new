...
class CaseStudiesControllerTest < ActionController::TestCase
  ...
  test "should create case_study" do
    assert_difference('CaseStudy.count') do
      post :create, case_study: { avatar: @case_study.avatar, description: @case_study.description, name: @case_study.name }
    end
  ...
  test "should update case_study" do
    put :update, id: @case_study, case_study: { avatar: @case_study.avatar, description: @case_study.description, name: @case_study.name }
    assert_redirected_to case_study_path(assigns(:case_study))
  end
